...
Places Bridgnorth in the first wave, on the ground that it owns material master and 11 of the fourteen sites cannot start until it completes. Any plan that schedules Bridgnorth after another dependent site earns nothing.

<sub>220 / 500 characters</sub>

### Criterion 2  ·  weight `4`  ·  _Rigid_

Schedules all three master data owners, Bridgnorth, Halesworth and Kinloss, in the first wave so that the dependency chain is released as early as possible. Scheduling a master data owner behind a site that consumes its domain earns nothing.

<sub>241 / 500 characters</sub>

### Criterion 3  ·  weight `5`  ·  _Rigid_

Schedules Cork early rather than late, recognising that its 12 week validation period runs after the technical cutover and that it must therefore begin by about programme week 28 to be live before support ends. Placing Cork in the final waves because it is the smallest site earns nothing.

<sub>289 / 500 characters</sub>

### Criterion 4  ·  weight `5`  ·  _Rigid_

Starts Sarnia in programme week 24 and Mobile in programme week 33, being their annual shutdown windows, and treats those weeks as fixed points around which the rest of the plan is built. Starting either site in any other week earns nothing.
...
Keeps the number of sites in cutover in any programme week at or below 3, the number of deployment teams. A plan requiring a fourth concurrent team in any week earns nothing.

<sub>174 / 500 characters</sub>

### Criterion 7  ·  weight `5`  ·  _Rigid_

Brings every site live on or before programme week 43, the week in which legacy support ends, treating Cork's live date as the end of validation rather than the end of its technical cutover. A plan in which any site goes live later earns nothing.

<sub>246 / 500 characters</sub>

### Criterion 8  ·  weight `4`  ·  _Rigid_

Respects every master data dependency listed in the site profile, so that no site begins its cutover before each of the sites it depends on has completed. A plan violating any single dependency earns nothing.

<sub>208 / 500 characters</sub>

### Criterion 9  ·  weight `4`  ·  _Rigid_

Uses the cutover durations given in the site profile without altering them, so that the fourteen sites consume 56 team weeks in total. Shortening a duration to make the plan fit earns nothing.

<sub>192 / 500 characters</sub>
...
Assigns each site to a named deployment team and shows the loading week by week, so that the concurrency constraint can be seen rather than asserted. A plan giving dates without team assignment earns nothing.

<sub>208 / 500 characters</sub>

### Criterion 12  ·  weight `3`  ·  _Rigid_

Does not schedule Charleston in the first wave despite it being the largest site at 580 users, because it depends on both Bridgnorth and Halesworth. A size-ordered plan that leads with Charleston earns nothing.

<sub>210 / 500 characters</sub>

### Criterion 13  ·  weight `2`  ·  _Rigid_

Converts programme week numbers to calendar dates using the stated start of programme week 1, so the plan can be read against the client's calendar. A plan expressed only in week numbers earns nothing.

<sub>201 / 500 characters</sub>

### Criterion 14  ·  weight `2`  ·  _Rigid_

Treats validation at Cork as not occupying a deployment team, so the team is released at the end of the technical cutover rather than at go-live. Holding a team through validation earns nothing.
